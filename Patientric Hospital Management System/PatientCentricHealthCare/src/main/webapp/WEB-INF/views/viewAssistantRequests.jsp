  ...
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="doctorLogin"><span class="glyphicon glyphicon-user"></span> Back</a></li>
...
<div class="row">
    ...
    <tbody>
         ...
         <td>${workReq.encounter.chiefComplaint}</td>
             ...
             <td><a href="<c:out value='medicate?encId=${workReq.encounter.encounterId}&workId=${workReq.requestId}'/>"><font color="red">Diagnose and Medication</font></a></td>
         </tr>	
        </c:forEach> 
    ...
    <tbody>
         ...
         <td>${workReq.requestId}</td>
         <td>${workReq.encounter.chiefComplaint}</td>
         <td>${workReq.encounter.vitalSign.bodyTemperature}</td>
         <td>${workReq.encounter.vitalSign.bloodPressure}</td>
         <td>${workReq.encounter.vitalSign.pulse}</td>
         <td>${workReq.encounter.vitalSign.repiratoryRate}</td>
    ...
    <tbody>
         ...
         <td>${workReq.requestId}</td>
         <td>${workReq.encounter.chiefComplaint}</td>
         <td>${workReq.encounter.assessment.assNotes}</td>
         <td>${workReq.encounter.assessment.pregnancy}</td>
         <td>${workReq.encounter.assessment.symptoms}</td>
         <td>${workReq.encounter.assessment.occurence}</td>
         <td>${workReq.encounter.assessment.std}</td>
         </tr>	
        </c:forEach> 
