...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
	...
	<h3>View/Manage Drugs</h3>
	<hr/>

 <form action="/hospitalapp/removeDrug" method="POST">
<div class="row">
    ...
    <tbody>
         ...
         <td>${drug.composition}</td>
             ...
             <td><input type="checkbox" name="deleteDrug" value="${drug.drugId}">delete</td>
         </tr>	
        </c:forEach> 
 ...
 <input type="submit"
                    value="<spring:message text="Delete Drug"/>" /> 
</form>
