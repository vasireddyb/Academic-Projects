...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="viewAssistantRequests"><span class="glyphicon glyphicon-user"></span> View Diagnosis Requests</a></li>
 ...
 <img src="<c:url value="/resources/img/doctor.png"/>" class="img-responsive" alt="Cinque Terre" width="904" height="336"> 
<h1>Instructions</h1>
