  ...
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="viewPatientsRequests"><span class="glyphicon glyphicon-user"></span> View Patient Requests</a></li>
	...
	<h3>Assistant Doctor Dashboard</h3>
	<hr/>

  <img src="<c:url value="/resources/img/assdoctor.jpg"/>" class="img-responsive" alt="Cinque Terre" width="904" height="336"> 
