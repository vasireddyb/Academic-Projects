...
<legend> Registration </legend>
	...
	<div class="field"><div class="label"><label>Password:</label></div><input id="password" class="required form" type="password" name="password" /></div>
	<div class="field"><div class="label"><label>Confirm Password:</label></div><input id="required password_confirm" class="required form" type="password" name="password_confirm" /></div>
	<div class="field"><div class="label"><label>Home Phone:</label></div><input id="homephone" class="required form" type="text" name="homephone" /></div>
	<div class="field"><div class="label"><label>Work Phone:</label></div><input class="form" type="text" name="workphone" /></div>
	<div class="field"><div class="label"><label>Mobile Number:</label></div><input class="required form" type="text" name="mobile" /></div>
	<div class="field"><div class="label"><label>Fax Number:</label></div><input class="form" type="text" name="fax" /></div>
	<div class="field"><div class="label"><label>IM Id:</label></div><input class="form" type="text" name="im" /></div>
	<div class="field"><div class="label"><label>Address1:</label></div><input class="required form" type="text" name="addr1" /></div>
	<div class="field"><div class="label"><label>Address2:</label></div><input class="form" type="text" name="addr2" /></div>
	<div class="field"><div class="label"><label>City</label></div><input class="required form" type="text" name="city" /></div>
	<div class="field"><div class="label"><label>State:</label></div><input class="required form" type="text" name="state" /></div>
	<div class="field"><div class="label"><label>Country:</label></div><select name="country" class="required form">
...
?>
	...
	<div class="field"><div class="label"><label>Pin Code:</label></div><input class="required form" type="text" name="pincode" /></div>
	<div class="field"><div class="label"><label>Date of Birth:</label></div><input id="datepicker" class="required form" type="text" value="1980-01-01" name="dob" /></div>
	<?php $randomcode = rand(); ?>
	<input name="randomcode" type="hidden" value="<?php echo $randomcode; ?>" />
	<div class="field"><div class="label"><label>Are You Human ?</label><br /><?php echo $randomcode; ?></div><input class="required form" type="text" name="humancode" /></div>
