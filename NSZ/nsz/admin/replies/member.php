...
<?php
	...
	$query = "SELECT * FROM REPLIES WHERE question_id='$qid' and type='1' AND (username='$username' OR visibility = '1' OR visibility = '3')";
	...
	$query1 = "SELECT * FROM REPLIES WHERE question_id='$qid' and type='1' AND (username='$username' OR visibility = '1' OR visibility = '3')";	
	...
	$result1 = mysql_query($query1);
		...
		while($row1 = mysql_fetch_array($result1)) { ?>
			...
			<b>Subject:</b> <?php echo $row1['subject']; ?>
			</div>
...
<?php
	...
	$query = "SELECT * FROM REPLIES WHERE question_id='$qid' AND type='0' AND (username='$username' OR visibility = '1' OR visibility = '3')";
	...
	$query1 = "SELECT * FROM REPLIES WHERE question_id='$qid' AND type='0' AND (username='$username' OR visibility = '1' OR visibility = '3')";	
