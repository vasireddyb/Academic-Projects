...
<?php
	...
	$query = "SELECT * FROM REPLIES WHERE type='1' and question_id='$qid'";
	...
	$query1 = "SELECT * FROM REPLIES WHERE type='1' and question_id='$qid'";	
...
<input type="radio" name="visibility" value="3" /> Member</div>
     ...
     <div style="text-align:right;" class="field"><input id="submit" class="button" type="submit" value="Post It !"  /></div>
</fieldset>
</form>
</div>
...
<?php
	...
	$query = "SELECT * FROM REPLIES WHERE question_id='$qid' and type='0'";
	...
	$query1 = "SELECT * FROM REPLIES WHERE question_id='$qid' and type='0'";	
