...
<div class="field" style="text-align:right; width:640px;padding-bottom:20px;background:#eee;"><a id="displayText" href="javascript:toggleChangePassword();">Change Password </a>
<div id="toggleChangePasswordText" style="display: none;">
<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
<div class="field"><div class="label"><label>New Password:</label></div><input type="text" class="form" disabled="disabled" value="" name="password"></div>
<div class="field"><div class="label"><label></label></div><input type="text" class="form" disabled="disabled" value="" name="cpassword"><input type="submit" value="Change Password" class="button"></div>
</form>
</div>
	...
	<div class="field"><div class="label"><label>username:</label></div><input type="text" class="form" disabled="disabled" value="<?php echo $row['username']; ?>" name="username"></div>
